% mobile_robot_sim: Function for simulating the system response given a
%                   sequence of controller parameters for k = 1, 2,..., N-1.
%
% Inputs:
...
function [ sim_out ] = mobile_robot_sim(model, task, theta)
    % time
    dt = task.dt;
    ...
    for k = 1:1:N-1
        ...
        state_dot = model.f(cur_state, cur_input, model);
